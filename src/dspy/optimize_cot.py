...
# Use ChainOfThought instead of Predict for CoT optimization
...
print("Optimizing CoT with MIPROv2...")
...
optimized_program.save("optimized_cot.json")
print("Saved optimized CoT program to optimized_cot.json")
